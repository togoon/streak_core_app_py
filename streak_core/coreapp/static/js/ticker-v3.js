...
var KiteTicker = function(params) {
	...
	this.connect = function() {
		...
		// 	}
		// });
		ws = new WebSocket("wss://ws.zerodha.com/?api_key=kitefront&user_id=YJ3548&public_token=z8HmXARhINdeNUNSzvEtBhjQQQbG6quo&uid="+new Date().getTime().toString()+"&user-agent=kite3-web&version=1.0.12");
