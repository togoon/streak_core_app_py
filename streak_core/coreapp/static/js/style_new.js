...
var order_window_params = {};// notif_id : params
...
function refresh_notification_(){
  ...
  for(var i=0; i<notificationsList.length;i++){
    ...
    if(notif['notification-type']=='order-webhook'){ // this is produced by worker.js
      ...
      if(notif['status']=='Completed' || notif['status']=='Algo Expired' || notif['status']=='Strategy Expired'){
        ...
        try{
          ...
          else if(notif['status']=='Algo Expired'||notif['status']=='Strategy Expired')
        ...
        a = '<li><div class="notif"><div class="notif_first_line"><span><img src="/static/imgs/new/orderlog/'+notif_image+'.svg"></span><p class="notif_tag '+notif_tag+'">'+notif['notification_title']+'</p><span></span></div> <div class="notif_second_line"> <div class="notif_second_line_desc_container"><p class="notif_desc">'+action_type2+' '+filled_quantity+'/'+quantity+' of '+notif.tradingsymbol+' at &nbsp;&#8377; '+avg_price+'</p><p class="notif_algo_name">'+notif.algo_name+'</p></div><div class="notif_second_line_algoname_container"><p class="notif_take_act"></p><p class="notif_time_stamp">'+date+'</p></div></div></div></li>';
...
function switch_option_selected_and_show_field(parent,remove_from,add_to){

}
function switch_order_type(e,switch_to,deployment_uuid){
  order_window_param = order_window_params[deployment_uuid];
  ...
  if(switch_to=='LIMIT'){
    ...
    order_window = update_order_window.apply(this,order_window_param);
  }
  if(switch_to=='MARKET'){
...
function generate_order_window2(transaction_type,trading_symbol,segment,order_type,quantity,product,price,trigger_price,disclosed_quantity,validity,variety,tag,notif_state,algo_name,algo_uuid,deployment_uuid,notification_uuid,notification_time,onclick_confirm='place_order',onclick_reject='cancel_notifications',readonly=false,display='block',tp=null,sl=null,tpsl_type=null){

  order_window_params[deployment_uuid]=[transaction_type,trading_symbol,segment,order_type,quantity,product,price,trigger_price,disclosed_quantity,validity,variety,tag,notif_state,algo_name,algo_uuid,deployment_uuid,notification_uuid,notification_time,onclick_confirm,onclick_reject,readonly,display,tp,sl,tpsl_type];

  order_body = '<div class="notif_window" style="display:'+display+'"><div class="notif_header notif_header_'+transaction_type.toLowerCase()+'"><p>'+transaction_type+'&nbsp;'+trading_symbol+'&nbsp;x'+quantity+'&nbsp;Qty<br><span>&#8377;'+parseFloat(trigger_price).toFixed(2)+'&nbsp;on&nbsp;'+segment+'</span></p><p class="view_history view_history_'+transaction_type.toLowerCase()+'" onclick="load_order_log_notif(event,\''+deployment_uuid+'\')">View History</p></div><div class="notif_body notif_body'+deployment_uuid+'"><div class="notif_options"><div><!--<div class="radio_options"><div><span id="'+transaction_type.toLowerCase()+'_radio_option"></span>-->' ;
  ...
  var order_price_html = 0;
  var order_price_readonly = 'readonly'
  var bg_stripe = 'bg-stripe';
  var cursor_style = '';
  ...
  if(order_type=='SL-M'){
    ...
    order_type_html = '<div class="radio_options product_option"><div onclick=switch_order_type(event,"MARKET",\''+deployment_uuid+'\')><span id="'+transaction_type.toLowerCase()+'_radio_option" class="radio_outer"><span class="radio_inner"></span></span><p id="option_selected">MARKET</p></div><div onclick=switch_order_type(event,"LIMIT",\''+deployment_uuid+'\')><span class="radio_outer"><span class="radio_inner"></span></span><p>LIMIT</p></div><div><span class="radio_outer"><span class="radio_inner"></span></span><p>SL</p></div><div><span class="radio_outer"><span class="radio_inner"></span></span><p>SL-M</p></div>';
  }
  else if(order_type=='LIMIT'){
    order_type_html = '<div class="radio_options product_option"><div onclick=switch_order_type(event,"MARKET",\''+deployment_uuid+'\')><span class="radio_outer"><span class="radio_inner"></span></span><p>MARKET</p></div><div onclick=switch_order_type(event,"LIMIT",\''+deployment_uuid+'\')><span id="'+transaction_type.toLowerCase()+'_radio_option" class="radio_outer"><span class="radio_inner"></span></span><p id="option_selected">LIMIT</p></div><div><span class="radio_outer"><span class="radio_inner"></span></span><p>SL</p></div><div><span class="radio_outer"><span class="radio_inner"></span></span><p>SL-M</p></div>';
    order_price_html = parseFloat(trigger_price);
  ...
  additional_option = '<div class="notif_left_more_options"></div><div class="bottom_more_options"><div class="reg_bo"><div class="radio_options"><div onclick=switch_order_type(eventv,"REGULAR",\''+deployment_uuid+'\')><span id="'+transaction_type.toLowerCase()+'_radio_option" class="radio_outer"><span class="radio_inner"></span></span><p id="option_selected">Regular</p></div><div onclick=switch_order_type(event,"BO",\''+deployment_uuid+'\')><span class="radio_outer"><span class="radio_inner"></span></span><p>BO</p></div></div></div><div id="notif_actions"><button onclick="'+onclick_confirm+'(event,\''+notification_uuid+'\',\''+deployment_uuid+'\',\''+algo_uuid+'\',\''+segment+'\',\''+trading_symbol+'\',\''+quantity+'\',\''+order_type+'\',\''+transaction_type.toUpperCase()+'\',\''+product+'\',\''+validity+'\',\''+algo_name+'\',\''+(moment()-moment(notification_time))+'\',\''+trigger_price_final+'\',\''+variety+'\',\''+notif_state+'\')" id="'+transaction_type.toLocaleLowerCase()+'">'+to_title(transaction_type)+'</button><button id="cancel" onclick="'+onclick_reject+'(event,\''+deployment_uuid+'\',\''+notification_uuid+'\',\''+notif_state+'\')">Cancel</button></div></div>';
  
  c='</div></div><div class="notif_left"><div class="notif_qty"><p>Qty.</p><input type="number" id="position_qty" name="" value="'+quantity+'" readonly></div><div class="notif_qty"><p>Price</p><input '+cursor_style+' type="number" name="" class="'+bg_stripe+'" id="position_price" value="'+order_price_html+'" '+order_price_readonly+'></div></div></div><div class="notif_options_price">'+order_type_html+'</div><div class="notif_right"><div class="notif_price"><p>Trigger price</p><input type="number" class="bg-stripe" id="position_trigger_price" name="" value="'+trigger_price_html+'" readonly></div><div class="notif_price"><p>Disclosed qty.</p><input type="number" class="bg-stripe" id="position_disclosed_qty" name="" value="0" readonly></div></div></div></div>'+additional_option+'</div></div></li>';
  ...
  if(variety=='BO' && tp!=null && sl!=null && product=='MIS' && segment!='MCX'){
    ...
    if(tpsl_type!='pct')
    {
      squareoff_val = parseFloat(tp);
      stoploss_val = parseFloat(sl);
      trailing_stoploss = '0';
    }
    else{
    ...
    bg_stripe = '';
    cursor_style = 'style="cursor: text !important;"';
    additional_option = '<div class="notif_left_more_options"><div class="notif_qty"><p>Stoploss</p><input '+cursor_style+' type="number" id="stoploss" name="" value="'+stoploss_val+'" '+order_price_readonly+'></div><div class="notif_qty"><p>Target</p><input '+cursor_style+' type="number" name="" id="squareoff" value="'+squareoff_val+'" '+order_price_readonly+'></div><div class="notif_qty"><p>Trailing stoploss</p><input '+cursor_style+' type="number" name="" id="trailing_stoploss" value="0" '+order_price_readonly+'></div></div><div class="bottom_more_options"><div class="reg_bo"><div class="radio_options"><div onclick=switch_order_type(event,"REGULAR",\''+deployment_uuid+'\')><span class="radio_outer"><span class="radio_inner"></span></span><p>Regular</p></div><div onclick=switch_order_type(event,"BO",\''+deployment_uuid+'\')><span id="'+transaction_type.toLowerCase()+'_radio_option" class="radio_outer"><span class="radio_inner"></span></span><p id="option_selected">BO</p></div></div></div><div id="notif_actions"><button onclick="'+onclick_confirm+'(event,\''+notification_uuid+'\',\''+deployment_uuid+'\',\''+algo_uuid+'\',\''+segment+'\',\''+trading_symbol+'\',\''+quantity+'\',\''+order_type+'\',\''+transaction_type.toUpperCase()+'\',\''+product+'\',\''+validity+'\',\''+algo_name+'\',\''+(moment()-moment(notification_time))+'\',\''+trigger_price_final+'\',\''+variety+'\',\''+notif_state+'\')" id="'+transaction_type.toLocaleLowerCase()+'">'+to_title(transaction_type)+'</button><button id="cancel" onclick="'+onclick_reject+'(event,\''+deployment_uuid+'\',\''+notification_uuid+'\',\''+notif_state+'\')">Cancel</button></div></div>';
    c='</div></div><div class="notif_left"><div class="notif_qty"><p>Qty.</p><input type="number" id="position_qty" name="" value="'+quantity+'" readonly></div><div class="notif_qty"><p>Price</p><input '+cursor_style+' type="number" name="" class="'+bg_stripe+'" id="position_price" value="'+order_price_html+'" '+order_price_readonly+'></div></div></div><div class="notif_options_price">'+order_type_html+'</div><div class="notif_right"><div class="notif_price"><p>Trigger price</p><input type="number" class="bg-stripe" id="position_trigger_price" name="" value="'+trigger_price_html+'" readonly></div><div class="notif_price"><p>Disclosed qty.</p><input type="number" class="bg-stripe" id="position_disclosed_qty" name="" value="0" readonly></div></div></div></div>'+additional_option+'</div></div></li>';
...
// SOLUTION: Individual functions for on click on Market vs Limit
// and Show additional options click
// and BO vs Regular click
function update_order_window(transaction_type,trading_symbol,segment,order_type,quantity,product,price,trigger_price,disclosed_quantity,validity,variety,tag,notif_state,algo_name,algo_uuid,deployment_uuid,notification_uuid,notification_time,onclick_confirm='place_order',onclick_reject='cancel_notifications',readonly=false,display='block',tp=null,sl=null,tpsl_type=null){

  order_window_params[deployment_uuid]=[transaction_type,trading_symbol,segment,order_type,quantity,product,price,trigger_price,disclosed_quantity,validity,variety,tag,notif_state,algo_name,algo_uuid,deployment_uuid,notification_uuid,notification_time,onclick_confirm,onclick_reject,readonly,display,tp,sl,tpsl_type];

  order_body = '<div class="notif_options"><div><!--<div class="radio_options"><div><span id="'+transaction_type.toLowerCase()+'_radio_option"></span>-->' ;
  ...
  additional_option = '<div class="notif_left_more_options"></div><div class="bottom_more_options"><div class="reg_bo"><div class="radio_options"><div onclick=switch_order_type(event,"REGULAR",\''+deployment_uuid+'\')><span id="'+transaction_type.toLowerCase()+'_radio_option" class="radio_outer"><span class="radio_inner"></span></span><p id="option_selected">Regular</p></div><div onclick=switch_order_type(event,"BO",\''+deployment_uuid+'\')><span class="radio_outer"><span class="radio_inner"></span></span><p>BO</p></div></div></div><div id="notif_actions"><button onclick="'+onclick_confirm+'(event,\''+notification_uuid+'\',\''+deployment_uuid+'\',\''+algo_uuid+'\',\''+segment+'\',\''+trading_symbol+'\',\''+quantity+'\',\''+order_type+'\',\''+transaction_type.toUpperCase()+'\',\''+product+'\',\''+validity+'\',\''+algo_name+'\',\''+(moment()-moment(notification_time))+'\',\''+trigger_price_final+'\',\''+variety+'\',\''+notif_state+'\')" id="'+transaction_type.toLocaleLowerCase()+'">'+to_title(transaction_type)+'</button><button id="cancel" onclick="'+onclick_reject+'(event,\''+deployment_uuid+'\',\''+notification_uuid+'\',\''+notif_state+'\')">Cancel</button></div></div>';
  
  c='</div></div><div class="notif_left"><div class="notif_qty"><p>Qty.</p><input type="number" id="position_qty" name="" value="'+quantity+'" readonly></div><div class="notif_qty"><p>Price</p><input '+cursor_style+' type="number" name="" class="'+bg_stripe+'" id="position_price" value="'+order_price_html+'" '+order_price_readonly+'></div></div></div><div class="notif_options_price">'+order_type_html+'</div><div class="notif_right"><div class="notif_price"><p>Trigger price</p><input type="number" class="bg-stripe" id="position_trigger_price" name="" value="'+trigger_price_html+'" readonly></div><div class="notif_price"><p>Disclosed qty.</p><input type="number" class="bg-stripe" id="position_disclosed_qty" name="" value="0" readonly></div></div></div></div>'+additional_option;
  ...
  order_window_params[deployment_uuid]=[transaction_type,trading_symbol,segment,order_type,quantity,product,price,trigger_price,disclosed_quantity,validity,variety,tag,notif_state,algo_name,algo_uuid,deployment_uuid,notification_uuid,notification_time,onclick_confirm,onclick_reject,readonly,display,tp,sl,tpsl_type];
  $('.notif_body').html(order_body+b+c);
  // return order_body+b+c;
    ...
    $.ajax(settings).done(function (msg){
        ...
        try{
            ...
            for(var j=0;j<log.length;j++)
                ...
                if(!['Waiting','Stopped','Completed','Force stopped','Algo Expired','Strategy Expired','Cancelled'].includes(log[j].log_tag) && (log[j].notification_data!=null || log[j].notification_data!={}))
                        ...
                        if(['Rejected'].includes(log[j].log_tag))
                        ...
                        else
                          {
                            if(take_action_notification_data!=null && j==0 && !['User action','At Exchange','SL-M Cancelled'].includes(log[j].log_tag))
                            {
                              ...
                              if(log[j].notification_data.variety!='BO'){
                              ...
                              else if(log[j].log_tag=='Cancelled'){
...
function refresh_notification(){
  ...
  for(var i=0; i<deploymentNotificationsList.length;i++){
    ...
    // if(notificationsUsed[notif['deployment_uuid']]!=undefined && notificationsUsed[notif['notification_uuid']]!=undefined)
        ...
        if(notif['notification-type']=="order-notification" || notif['notification-type']=="discipline-notif" || notif['price_trigger-notification']!=undefined)
          {
            ...
            order_body = generate_order_window2(transaction_type=notif['action_type'],trading_symbol=notif['sym'],segment=notif['seg'],order_type=order_type,quantity=notif['quantity'],product=order_product,price=0,trigger_price=notif['trigger_price'],disclosed_quantity=0,validity='DAY',variety=variety,tag='',notif_state=notif_state,algo_name=notif['algo_name'],algo_uuid=notif['algo_uuid'],deployment_uuid=notif['deployment_uuid'],notification_uuid=notif['notification_uuid'],notification_time=notif['notification_time'],onclick_confirm='place_order',onclick_reject='cancel_notifications',readonly=false,display='none',tp=target_profit,sl=stop_loss,tpsl_type=tpsl_type);
      ...
      if (order_window_exits)
        notif_row_on_click = 'show_order_window(event,"'+notif['deployment_uuid']+'","'+notif['notification_time']+'",'+order_window_exits+',"'+notif['notification_uuid']+'","'+variety+'","'+notif_state+'")';
      else
...
function show_order_window(event,deployment_uuid,notification_time,order_window_exits,notification_uuid,variety=null,notif_state=null){
  if (variety=='BO' && notif_state!=null){
    if(notif_state.toUpperCase()=='EXIT'){
          ...
          if(positionsDict[sym_seg]!=undefined){
            for (var k in positionsDict[sym_seg]){
              ...
              if(avg_price==0 && qty == 0 && net_pnl == 0){
                $('#live__'+k.replace('&','\\&').replace(/ /g,'_-_')).html('<span style="color: #383838;font-weight: 400;">&nbsp;</span><span class="na_class">N/A</span><!--<span style="color: #bfc7d1;font-weight: 400;" style="display:none>('+'N/A'+'%)&nbsp;</span>-->');
                continue;
              }
          ...
          if(positionsDict[sym_seg]!=undefined){
            for (var k in positionsDict[sym_seg]){
              ...
              else if(sym_seg.split('_')[0]=='MCX')
              {
                ...
                if (comm_multiplier==undefined)
                  comm_multiplier = 1;
                net_pnl = net_pnl*comm_multiplier;
              }
              ...
              if(avg_price==0 && qty == 0 && net_pnl == 0){
                $('#live__'+k.replace('&','\\&').replace(/ /g,'_-_')).html('<span style="color: #bfc7d1;font-weight: 400;">&nbsp;</span><span class="na_class">N/A</span><!--<span style="color: #bfc7d1;font-weight: 400;" style="display:none>('+'N/A'+'%)&nbsp;</span>-->');
                continue;
              }
              else if(net_pnl!=0 && qty==0)
              {
              ...
              else if(qty!=0)
              {
                ...
                pnl = parseFloat((tick['last_price']-avg_price)*qty_actual*comm_multiplier+net_pnl).toFixed(2);
                if(avg_price!=0)
...
function place_order(event,notification_uuid,deployment_uuid,algo_uuid,seg,sym,quantity,order_type,transaction_type,product,validity,algo_name,dt=0,trigger_price=0.0,variety='REGULAR',notif_state=''){
    var me = $(event.target);
    ...
    if(order_type=='LIMIT'){
      price=$('.notif_body'+deployment_uuid+' '+'#position_price').val();
      params['price']=price;
      params['order_type']=order_type;
    }
    if(order_type=='LIMIT' && variety=='BO' && product=='MIS' && seg!='MCX'){
      squareoff=$('.notif_body'+deployment_uuid+' '+'#squareoff').val();
      stoploss=$('.notif_body'+deployment_uuid+' '+'#stoploss').val();
      trailing_stoploss=$('.notif_body'+deployment_uuid+' '+'#trailing_stoploss').val();
...
function place_order_tpsl(event,notification_uuid,deployment_uuid,algo_uuid,token,quantity,order_type,transaction_type,product,validity,tpsl_key,algo_name,dt=0,trigger_price=0.0,variety='REGULAR',notif_state=''){
    var me = $(event.target);
